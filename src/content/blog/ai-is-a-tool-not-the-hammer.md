---
title: AI is a tool not the hammer
description: |-
...
A friend of mine sent me this [case study from Microsoft](https://docs.microsoft.com/en-us/learn/modules/ai-strategy-to-create-business-value/3-transform-applications-case-study-introduction) that outlined a number of strategy questions for a company. The strategy questions were framed around ways AI could be used to address a number of issues facing the company. The impact of AI was impressive and it's easy to see why so many companies are enamored by this new set of tools.
...
- Incorporate Responses into Strategy & Align with Execution using [Fluid Prioritization](https://www.enablingvalue.com/stories/introducing-fluid-prioritization-using-multi-factor-analysis-part-1)

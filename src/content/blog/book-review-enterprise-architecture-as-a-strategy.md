---
title: 'Book Review: Enterprise Architecture as a Strategy'
...
1. Business Case - understanding how to measure value against cost to assess an investment
2. Prioritizing Investments - determining which technology initiatives to fund
3. Management Capabilities - ability to leverage IT benefits (this is the shift in thinking)
4. Management Ownership for identifying value - to guide the definition of technology enabled business services
5. Technology Governance - establishing standards for local & enterprise-wide use of technology, aligning investment priorities with EA objectives, sourcing and funding technology extensions in business modularity

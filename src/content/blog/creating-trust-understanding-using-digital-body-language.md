---
title: Creating TRUST & Understanding Using Digital Body Language
...
[https://www.linkedin.com/learning/digital-body-language/the-empathy-deficit](https://www.linkedin.com/learning/digital-body-language/the-empathy-deficit)
...
These are never more evident than when watching how content is conveyed in courtrooms. The level of intonation, gestures, carefully planted semantics, and theater of presentation all serve to sway judges and juries alike. If you have ever read a transcript of a Trump speech, it is intelligible. But, when you see him deliver it with all the visual and auditory cues, it’s very clear what he is saying directly and indirectly (like any master magician - the term is purposefully chosen).
...
Erica has provided some interesting research about the conveyance of TRUST through body language and the impact of any one of these variables around modality (channels, tools), persona (ethnographic, psychographic, geographic, demographics, ..), and the physical presentation (emotions, confidence, clarity, expression). Still… a ton of information to absorb and consider and way more than anyone person can model and prepare for every interaction (online or otherwise).

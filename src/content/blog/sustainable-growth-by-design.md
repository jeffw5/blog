---
title: Sustainable Growth by Design
...
Before jumping into a large project, it may be useful to conduct a small (4-week) initiative to demonstrate how [Biz:DNA](https://www.enablingvalue.com/managing-complexity) can provide value for a limited scope. 

We call these Proof of Value (POV), since the concept already works. The goal is to learn about [Biz:DNA](https://www.enablingvalue.com/managing-complexity) and see how it can quickly improve awareness and understanding and deliver meaningful results for key stakeholders. 
